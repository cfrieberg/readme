...
- **SaaS Management and Automation**: Experienced in managing **SaaS platforms**, specializing in automating **onboarding and offboarding workflows** using **BetterCloud**. As a **BetterCloud Certified Admin**, leveraged integrations and APIs to seamlessly grant new hires access to essential systems and streamline user lifecycle management.
